...
<div class="modal fade mdl_driver" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">                
                <table class="table">
                    <?php if(!empty($order_details["driver_details"])) { ?>
                    <tr>
                        <th>Driver Name</th>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="panel-body">
                        ...
                        <?php if( $order_details["order_status"] == 1 || $order_details["order_status"] == 6 || $order_details["order_status"] == 2 || $order_details["order_status"] == 3){ ?>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <button type="button" style="background-color: #f8ac59;border-color: #f8ac59;color: #FFFFFF;" data-toggle="modal" data-target=".mdl_driver" class="form-control btn btn-md btn-warning" id="driver_details">View Delivery Driver Details</button>
                                </div>
                            </div>
                        </div>
                        <?php } else { ?>
