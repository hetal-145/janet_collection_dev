<?php //echo "<pre>"; print_r($trading_hours_details); exit; ?>
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2> Edit Trading Hours</h2>
        <ol class="breadcrumb">
            <li>
                <a href="home">Home</a>
            </li>
            <li class="active">
                <strong> Edit Trading Hours</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="ibox float-e-margins">
			    ...
			    <input type="hidden" name="thr_id" value="<?php echo $trading_hours_details["thr_id"]; ?>" id="thr_id">
				...
				<option value="<?php echo $key; ?>" <?php if($trading_hours_details["weekday"] == $key) { ?> selected="selected" <?php } ?>><?php echo $value; ?></option>
				<?php } ?>
			    </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control stime_picker start_time" placeholder="Start Time" name="start_time" value="<?php echo $trading_hours_details["start_time"]; ?>">
                        </div>
			
			<div class="form-group">
                            <span class="help-block m-b-none"><b>End Time(*)</b></span>
                            <input type="text" class="form-control etime_picker end_time" placeholder="End Time" name="end_time" value="<?php echo $trading_hours_details["end_time"]; ?>">
                        </div>
