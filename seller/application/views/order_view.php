...
<!--                                <tr <?php /*if( $order_details["order_status"] == 4 ) { if( strtotime($order_details["delivered_date"]) < strtotime(date("Y-m-d H:i:s"))) { echo 'class="hidden"'; } } ?> <?php if( $order_details["order_status"] == 5 || $order_details["order_status"] == 7 ) {  echo 'class="hidden"'; }*/ ?>>-->
				...
				<tr>
						    ...
						    <th>Seller Contact No</th>
                                                ...
                                                <tr>
						    <td><?php echo $order_details["seller"]["seller_name"]; ?></td>
                                                    <td><?php echo $order_details["seller"]["email"]; ?></td>
                                                    <td><?php echo $order_details["seller"]["contact_no"]; ?></td>
                                                </tr>  
                                            </tbody>
                                        </table>
                                    </td>
				...
				<?php //if( $order_details["driver_available"] == 1){ ?>
				    <div class="col-md-4">
					<div class="form-group">
					    <button type="button" style="background-color: #1ab394;border-color: #1ab394;color: #FFFFFF;" data-toggle="modal" data-target=".mdl_change_status" class="form-control btn btn-md btn-primary" id="change_status">Change the Status of Order</button>
					</div>
				    </div>
				<?php /*} else { ?>
				    <div class="col-md-12">
					<div class="form-group">
					    <label class="control-label" style="color: red;"> Currently, no driver is available for delivery. Please wait. </label>
					</div>
				    </div>
				<?php }*/ ?>
			    <?php } ?>
			    
			    <?php if( $order_details["order_status"] == 3 && !in_array('1', $pickip) ){ ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <button type="button" style="background-color: #1ab394;border-color: #1ab394;color: #FFFFFF;" class="form-control btn btn-md btn-primary" id="order_pickup">Order Pickup</button>
                                </div>
                            </div>
			    <?php } ?>
                        </div>
