					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0" border="0" width="580" align="center" class="content-width center">
							...
							<tr>
								...
								<h3 style="margin: 0;letter-spacing: .5px;">Welcome to Janet-Collection <br/><span style="color: #ec1d74;"> password recovery system.</span></h3>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; text-transform:capitalize; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;color: #171717;">Please find the login detail </p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
								...
								<p style="font-size: 16px;letter-spacing: .5px;">Email ID: <strong><?= $email ?></strong></p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;">Password: <b><?= $password ?></b></p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; text-transform:capitalize; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;">For Support: <a style="color: #ec1d74;text-decoration: underline !important;" href="mailto:shoutout@predrinkdelivery.com">Mail Us Here</a></p>
							    </td>
							</tr>      
						    </tbody>
						</table>
