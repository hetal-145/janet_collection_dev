...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="../../../js/layout.html"></script>
        <title></title>
    ...
    <!-- Banner Begins -->
    <body yahoo="fix" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#f2f2f2" style="font-family: 'Open Sans', sans-serif; background-color:#f2f2f2;">
        <!-- Menu & Logo Section Begins -->
        <table align="center" cellpadding="0" cellspacing="0" border="0" width="600" bgcolor="#f3f3f2" style="table-layout:fixed;margin:0 auto; width:100%; max-width:600px;" class="white_bg">
            <tbody>
                <tr>
                    <td height="15" style="font-size: 23px; line-height: 23px;" class="hidden-space1">&nbsp;</td>
                </tr>
            </tbody>
        </table>

        <table align="center" cellpadding="0" cellspacing="0" border="0" width="600" bgcolor="#ec1d74" style="table-layout:fixed;margin:0 auto; width:100%; max-width:600px;" class="white_bg">
            <tbody>
                <tr>
                    <td>
                        <!-- Layout Width -->
                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600" class="mobile-width" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                            <tbody>
                                <tr>
                                    <td align="center">
                                        <!-- Container Width -->
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600" class="content-width" style="background-color: #ec1d74;">
                                            <tbody>
                                                <tr>
                                                    <td align="center">
                                                        <table cellpadding="0" cellspacing="0" border="0" align="center" class="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <table align="center" cellspacing="0" width="10" height="24" cellpadding="0" border="0" class="full-width">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td height="55" style="font-size: 0;line-height: 0;border-collapse: collapse;">
                                                                    ...
                                                                    <td align="center" valign="middle"><a href="#" target="_blank" style="padding-top: 16px;color: #16a085; display:block; max-height:100%;text-align: center;padding-bottom: 16px;" >
                                                                            <img src="https://www.Janet-Collection.com/ws/v1/application/views/mail_tmp/mail_img/logo.jpg" style="margin: 0 auto;" alt="" width="220" height=""  />
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <table align="center" cellspacing="0" width="10" height="24" cellpadding="0" border="0" class="full-width">
