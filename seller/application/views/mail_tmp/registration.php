					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0" border="0" width="580" align="center" class="content-width center">
							...
							<tr>
								...
								<h3 style="margin: 0;letter-spacing: .5px;">Hi! <br/><span style="color: #ec1d74;"><?= $first_name ?>&nbsp;<?= $last_name ?></span></h3>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; text-transform:capitalize; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;color: #171717;">Your account has been successfully registered.</p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; text-transform:capitalize; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;">Your Login Details: </p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;">Your Email ID is <b><?= $email ?></b></p>
							    </td>
							</tr>
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px;  mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;">Your Password is <b><?= $password ?></b></p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; text-transform:capitalize; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;text-align: center;"><b>please wait your account under verification. <br> you can login after verified your account.</p>
							    </td>
							</tr>
						    </tbody>
						</table>
