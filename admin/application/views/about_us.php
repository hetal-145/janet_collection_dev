        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form name="aboutus_frm" class="aboutus_frm">
                        <div class="summernote" style="width: 100%; height: 250px;" id="about_us" name="about_us" >
                            <?php echo $res['value'];
                            ?>
                        </div>
                        <input type="hidden" class="about_us" name="about_us" />
...
<script>
    $(document).on('click', '.save_btn', function () {
        ...
        var in_pp = $('.aboutus_frm .summernote').code();
