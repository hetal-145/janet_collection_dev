        ...
        <div class="col-lg-12">
			...
			<div class="col-sm-12">
				...
				<div class="row samevoldiv">				
					...
					<input type="text" class="form-control normal_sell_price" name="normal_sell_price" value="<?php echo $value["normal_sell_price"]; ?>">
				    </div>
					...
					<input type="text" class="form-control loyalty_club_sell_price" name="loyalty_club_sell_price" value="<?php echo $value["loyalty_club_sell_price"]; ?>">
				    </div>
					...
					<input type="text" class="form-control vip_club_sell_price" name="vip_club_sell_price" value="<?php echo $value["vip_club_sell_price"]; ?>">
				    </div>
