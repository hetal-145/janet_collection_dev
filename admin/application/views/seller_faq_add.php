                ...
                <div class="ibox-content">
                    ...
                    <form name="faq" class="faq">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control faq_ques" placeholder="Faq Question" name="faq_ques">
                        </div>
...
<script>
    $(document).on('click', '.save_btn', function () {
        ...
        if (seller_id == '') {
            frm.find('[name = "seller_id"]').addClass('input_error').parents('.form-group').append(error_msg('Please select seller'));
            valid = false;
        } 
        ...
        if (valid == true) {
		    ...
		    'seller_id' : $("#seller_id").val()
                ...
                success: function (data) {
                    if (data == 'success') {
                        window.location = "seller_faq_list";
                    }
                }
            });
        } else {
