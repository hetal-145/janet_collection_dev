...
class Business_users extends CI_Controller {
    ...
    public function index() {
        ...
        $xcrud->columns('firstname,email,mobileno,loyalty_point,wallet,is_vip_club_member, verify_doc', false);
        $xcrud->fields('ufirstname,ulastname,userno,birthdate,email,mobileno,member_since,is_vip_club_member, verify_doc, status');
        ...
        //View Document
        $xcrud->button('../../upload/verification_docs/{verification_doc}', 'View Document', 'glyphicon glyphicon-eye-open', 'btn-success', array(
            'target' => '_blank'
        ), array(
                'verification_doc', '!=', ''
            ));         
        ...
        //Past Orders
        $xcrud->button('business_users/user_order_history?uid={user_id}', 'Past Orders', 'glyphicon glyphicon-list', 'btn-warning');
        
        //Delete Document
        $xcrud->create_action('delete', 'delete_user_doc');
        $xcrud->button('#', 'Delete Document', 'glyphicon glyphicon-trash', 'xcrud-action btn-danger', array(
            'data-task' => 'action',
            'data-action' => 'delete',
            'data-primary' => '{user_id}'), array(
                'verification_doc', '!=', ''
        ...
        //Refund Order
        $xcrud->button('business_users/product_return_history?uid={user_id}', 'Refund Amount', 'glyphicon glyphicon-transfer', 'btn-success');
    ...
    public function product_return_history() {
        ...
        //Refund Order
        //$xcrud->button('business_users/refund_order?oid={product_return_id}', 'Refund', 'glyphicon glyphicon-transfer', 'btn-success', '', array('amount_refunded','=','0'));
    ...
    function refund_order(){
        ...
        redirect(base_url('business_users/product_return_history?uid='.$return["user_id"]), 'refresh');
