...
<!--                <div class="prod_img_box">
                ...
                <div id="prod_carousel" class="carousel slide prod_img_box" data-ride="carousel">
                    ...
                    <ul class="carousel-indicators">
                        <li data-target="#prod_carousel" data-slide-to="0" class="active"></li>  
			<?php 
			if(!empty($product_details["gallery_img"][0]["image_name"])) { 
			    foreach($product_details["gallery_img"] as $key => $gallery_img) {
				$k = $key+1;
			?>
			<li data-target="#prod_carousel" data-slide-to="<?php echo $k; ?>"></li>
			<?php
			    }
			}
			?>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 content-right align-self-center ">
                ...
                <div class="row mb-3">
                    <div class="col-4 align-self-center">
                        <p class="prod_price mb-0"><?php echo CURRENCY_CODE . $product_details["price"]; ?> <small class="discount_price"><strike><?php echo CURRENCY_CODE . $product_details["actual_price"]; ?></strike></small></p>
                    </div>
		...
		<p class="prod_by_admin">Country of Origin: <?php echo $product_details["country_id"]; ?></p>
		<p class="prod_by_admin">Category: <?php echo $product_details["category_name"]; ?></p>
                <p class="prod_by_admin">Brand: <?php echo $product_details["brand_name"]; ?></p>
                    ...
                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        <select class="form-control volumes" name="volume_id" id="volume_id" style="height: 100% !important;">
                            <?php foreach ($product_details["volume_id"] as $key => $vol) { ?>
                                <option value="<?php echo $vol["volume_id"]; ?>" data-price="<?php echo CURRENCY_CODE . $vol["actual_price"]; ?>"><?php echo $vol["volumes"]; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <?php foreach ($similar_products as $tpicks) { ?>
                        <div class="pt-2 pb-2">
                            <div class="card product_card">
                                <a title="<?php echo $tpicks["product_name"]; ?>" href="<?php echo base_url() . 'products/product_detail?pid=' . base64_encode($tpicks["product_id"]); ?>">
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".add_to_bag").click(function () {
			...
			$("#modal_submit_reviews").find(".alert_msg").html("Item Already Added in Cart.");
			...
			$("#modal_submit_reviews").find(".alert_msg").html("Quantity out of stock.");
                        ...
                        $("a.modal_submit_reviewss").trigger("click");
			$("#modal_submit_reviews").find(".alert_msg").html("Item added to cart.");
			...
			$("#modal_submit_reviews").find(".alert_msg").html("No data found.");
                        ...
                        $("a.modal_submit_reviewss").trigger("click");
			$("#modal_submit_reviews").find(".alert_msg").html("Your age is not verified.");
                    }
		    else if (resp == 6) {
                        $("a.modal_submit_reviewss").trigger("click");
			$("#modal_submit_reviews").find(".alert_msg").html("The product selected falls outside your delivery zone.");
                    }
                }
            });
        });
