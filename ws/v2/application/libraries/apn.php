...
class APN {
     ...
     * @param <string> $sound
     */
    public function sendMessage($deviceToken, $title, $message, $badge = NULL, $sound = NULL, $expiry = '', $newstand = false) {
        $this->error = '';
        ...
        $payload = $this->generatePayload($title, $message, $badge, $sound, $newstand);
