        ...
        if(!empty($userdata["user_id"])) {
            ...
            // if($check_para) {
                if (isset($_FILES["profile_image"]['name']) && !empty($_FILES["profile_image"]['name'])) {
                    ...
                    $_POST['filename'] = $_FILES["profile_image"]['name'];
                    ...
                    $pic_res1 = $aObj->upload_image($pic_res["url"], $_FILES);
                    unset($aObj);
                    // print_r($pic_res); exit;
                    $post['image_profile'] = $pic_res["filename"];
                }
                else if (isset($_POST["profile_image"]) && empty($_POST["profile_image"])) {
                    $post['image_profile'] = "";
                }
                ...
                else if (isset($_POST["cover_image"]) && empty($_POST["cover_image"])) {
                    $post['image_cover'] = "";
                }
