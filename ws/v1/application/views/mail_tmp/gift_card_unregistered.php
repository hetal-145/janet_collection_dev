				...
				<table cellspacing="0" cellpadding="0" border="0" width="600" class="content-width">
					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0" border="0" width="580" align="center" class="content-width center">
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; text-transform:capitalize; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;">You can use this amount<br/>for your next purchase from <a style="color: #ec1d74;text-decoration: underline !important;" href="https://www.drinxin.com/">drinxin.com</a></p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
							...
							<tr>
							    <td align="center" class="center white_color" style="font-family: 'Open Sans',sans-serif; font-size: 20px; text-transform:capitalize; mso-line-height-rule:exactly; line-height:35px;">
								<p style="font-size: 16px;letter-spacing: .5px;text-align: center;"><b>Your gift card code</b><br><?= $code ?></p>
							    </td>
							</tr>
							<tr>
							    <td height="20"></td>
